...
/datum/equipment_preset/survivor/iasf/load_gear(mob/living/carbon/human/new_human)
	...
	switch(random_number)
		...
		if(3)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/mask/neckerchief/brown(new_human.back), WEAR_IN_BACK)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/jacket/marine/rmc/service/iasf_combat_jacket(new_human), WEAR_JACKET)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/marine/veteran/iasf_beret(new_human), WEAR_HEAD)
...
/datum/equipment_preset/synth/survivor/iasf_synth/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/veteran/royal_marine/light/iasf/synth(new_human), WEAR_JACKET)
