...
/atom/movable/screen/escape_menu/home_button/Initialize(
	...
	screen_loc = "NORTH:-[100 + (21 * offset)],WEST:110"
...
/atom/movable/screen/escape_menu/home_button/admin_help/Initialize(
	...
	RegisterSignal(escape_menu.client, COMSIG_CLIENT_VERB_ADDED, PROC_REF(on_client_verb_changed))
	RegisterSignal(escape_menu.client, COMSIG_CLIENT_VERB_REMOVED, PROC_REF(on_client_verb_changed))
